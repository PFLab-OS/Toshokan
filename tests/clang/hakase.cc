...
int test_main() {
  extern uint8_t _binary_tests_clang_friend_bin_start[];
  extern uint8_t _binary_tests_clang_friend_bin_size[];
  size_t binary_tests_clang_friend_bin_size =
      reinterpret_cast<size_t>(_binary_tests_clang_friend_bin_size);

  Loader16 loader16;
  ElfLoader elfloader(_binary_tests_clang_friend_bin_start,
                      binary_tests_clang_friend_bin_size);
