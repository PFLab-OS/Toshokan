...
void friend_main()
{
  ...
  *((uint32_t *)0xfee000f0) = (1 << 8); // enable local apic (WARNING: too rough. read Intel SDM)
  ...
  *((uint64_t *)(0xfed00000UL + 0x110 + i * 0x20)) = vector | ((0xfee00000UL /* reserved */ | (1 << 12) /* destination */) << 32); // fsb data & address
  asm volatile("sti");
  *((uint64_t *)(0xfed00000UL + 0x100 + i * 0x20)) = (1 << 14) | (1 << 2); // Tn_FSB_EN_CNF | Tn_INT_ENB_CNF
