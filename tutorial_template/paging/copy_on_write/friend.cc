...
extern "C" void fault_handler() {
  ...
  pt.entry[fault_entry] = (0x50000000 + fault_entry * 0x1000) | (1 << 0) | (1 << 1) | (1 << 2);
  int src_entry = fault_entry - 256;
  pt.entry[src_entry] |= (1 << 1);
  my_memcpy((void *)(0x50000000 + fault_entry * 0x1000), (void *)(0x50000000 + src_entry * 0x1000), 0x1000);
